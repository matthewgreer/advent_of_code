...
const calculateChecksum = (input, part) => {
  const driveMap = makeDriveMap(input);
  const compactedDrive = compactDrive(driveMap);
...
// const checksum = calculateChecksum(testInput);
